function car_rental(nb_km, nb_days){
    ...
    if(cost_km > cost_days){
        console.log("le cout favorable est cost_days avec : " + cost_days + " dirham");
    }else{
        console.log("le cout favorable est cost_km avec : " + cost_km + " dirham");
    }
}
console.log(car_rental(1500, 1))